...
import com.mk.newsapp.databinding.FragmentEntertainBinding;
...
public class EntertainFragment extends Fragment {
    ...
    FragmentEntertainBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_entertain,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.recycentertain.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new RecyclerAdapter(getContext(),modelClassArrayList);

        binding.recycentertain.setAdapter(adapter);
